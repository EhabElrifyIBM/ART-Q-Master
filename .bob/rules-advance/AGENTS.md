...
- This mode has access to MCP servers and browser automation tools
- Can integrate external APIs and web scraping capabilities
- Use for tasks requiring external data sources or web interactions