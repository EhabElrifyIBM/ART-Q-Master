...
class MainWindow(QMainWindow):
    ...
    def repopulate_handlers(self, handler_list):
        ...
        # Chat Agent supporter name input
        supporter_row = QWidget()
        supporter_layout = QHBoxLayout(supporter_row)
        supporter_layout.setContentsMargins(25, 2, 5, 2)
        
        supporter_label = QLabel("Supporter Name:")
        supporter_label.setStyleSheet("font-size: 12px; color: #525252;")
        supporter_layout.addWidget(supporter_label)
        ...
        supporter_layout.addWidget(self.chat_agent_input)
        supporter_layout.addStretch()
        
        self.scroll_layout.addWidget(supporter_row)
